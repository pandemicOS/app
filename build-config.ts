...
app.expo.name = isProd ? 'PandemicOS - Coronavirus' : `${env} PandemicOS - Coronavirus`;
app.expo.slug = isProd ? 'pandemic-os-coronavirus' : `${env}-pandemic-os-coronavirus`;
app.expo.version = app.expo.ios.buildNumber = packageJSON.version;
app.expo.ios.bundleIdentifier = app.expo.android.package = isProd ? 'com.pandemicos.coronavirus' : `com.pandemicos.coronavirus.${env}`;
